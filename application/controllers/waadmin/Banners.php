...
class Banners extends CI_Controller{
  private $ctr_name;
    ...
    private $primary_table = "banner"; //Tabla principal
    public $base_title = "Banner";
    ...
    function index(){
        ...
        $data['total_registros'] = $this->Banner->total_registros($post);

        //Listado
        $data['listado'] = $this->Banner->listado($per_page, $page, $post);
    ...
    $this->template->title($data['tipo'] . ' Banner');
