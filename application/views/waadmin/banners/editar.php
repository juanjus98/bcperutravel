               ...
               <div class="col-sm-12">
                 ...
                 <table class="table table-bordered">
                   ...
                   <tr>
                     <td>
                       <div class="form-group" style="margin-bottom: 0px;">
                         <label for="url" class="col-sm-2 control-label" style="text-align: right;"> URL:</label>
                         <div class="col-sm-4">
                           <input name="url" id="url" type="text" value="<?php echo $retVal = (!empty($post['url'])) ? $post['url'] : '';?>" class="form-control input-sm">
                           <?php echo form_error('url', '<div class="error">', '</div>'); ?>
                         </div>
                         <label for="target" class="col-sm-2 control-label" style="text-align: right;"> Target:</label>
                         <div class="col-sm-4">
                           <!-- <input name="orden" id="orden" type="text" value="<?php echo $retVal = (!empty($post['orden'])) ? $post['orden'] : '';?>" class="form-control input-sm"> -->
                           <select name="target" id="target" class="form-control input-sm">
                             <?php
                             $targets = array(
                              '_self' => 'En la misma página',
                              '_blank' => 'En una nueva página'
                            );
                             foreach ($targets as $key => $value) {
                               $selected = ($key == $post['target']) ? 'selected' : '' ;
                       ...
                       <div class="form-group" style="margin-bottom: 0px;">
                         ...
                         <div class="col-sm-10">
                          <div class="alert alert-warning alert-dismissable">
                            ...
                            <b>Atención!</b> Medidas 600px * 555px.
                          </div>
                          ...
                          if(!empty($post['imagen_1'])){
                           ?>
                           <p class="help-block">
                             <a href="<?php echo base_url($upload_path . $post['imagen_1']);?>" target="_blank">
                               <img src="<?php echo base_url($upload_path . $post['imagen_1']);?>" style="max-height: 60px;">
                             </a>
                           </p>
                           <?php }?>
                         </div>
