...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <form name="frm-buscar" id="frm-buscar" method="post" action="" role="search">
                    <div class="row pad" style="padding-bottom: 0px;">
                        ...
                        <div class="col-sm-2">
                            <a href="<?php echo base_url('waadmin/banners/index?refresh');?>" class="btn btn-default btn-sm" title="Restablecer"><i class="fa fa-undo" aria-hidden="true"></i> Restablecer </a>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <div class="pull-right">
                                ...
                                <a href="<?php echo base_url('waadmin/banners/editar/C');?>" class="btn btn-success btn-sm" title="Agregar"><i class="fa fa-plus-circle" aria-hidden="true"></i> Agregar </a>
            ...
            <form name="index_form" id="index_form" action="<?php echo base_url(); ?>waadmin/banners/eliminar" method="post">
                            ...
                            if(!empty($listado)){
                                foreach ($listado as $key => $item) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            $image_url = base_url($upload_path . $item['imagen_1']);
                                        ?>
                                        <a href="<?php echo $image_url;?>" target="_blank">
                                            <img src="<?php echo $image_url;?>" style="max-height:60px;">
                                        </a>
                                        </td>
                                        <td class="text-center"><a href="<?php echo $item['url']; ?>" target="_blank"><?php echo $item['url']; ?></a></td>
                                        <td class="text-center"><?php echo $item['orden']; ?></td>
                                        <td class="text-center">
                                            <a href="<?php echo base_url(); ?>waadmin/banners/editar/V/<?php echo $item['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Visualizar"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="<?php echo base_url(); ?>waadmin/banners/editar/E/<?php echo $item['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>
