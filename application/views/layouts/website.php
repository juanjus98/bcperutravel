...
<div id="header_1">
 ...
 <div class="col-md-6 col-sm-6 col-xs-12">
  <a href="tel://+512630012">+51 263 0012</a>
 </div>
 <div class="col-md-6 col-sm-6 hidden-xs">
 <ul id="top_links" class=""><li id="menu-item-164" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-164"><a href="#">Wishlist</a></li>
<li id="menu-item-165" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-165"><a href="#0">PURCHASE THIS TEMPLATE</a></li>
</ul>
 </div>
 </div>
 <!-- End row -->
...
<!-- JavaScript-->
<link href="https://fonts.googleapis.com/css?family=Lato:300,400|Lobster" rel="stylesheet">
</body>
</html>
